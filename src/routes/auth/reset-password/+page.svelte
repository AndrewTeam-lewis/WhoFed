...
<svelte:head>
  <title>Reset Password - Na Régua</title>
</svelte:head>
...
<div class="min-h-screen bg-gray-50 flex items-center justify-center p-4 md:p-6">
  <div class="w-full max-w-md bg-white rounded-2xl shadow-sm p-6 md:p-8">
    ...
    <h1 class="text-2xl md:text-3xl font-bold text-gray-800 text-center mb-2">Create New Password</h1>
    <p class="text-sm text-gray-500 text-center mb-6 md:mb-8">Enter your new password below</p>
