-- Fix cron function to use actual Supabase service role key instead of placeholder
-- This allows the cron job to authenticate when calling the send-push Edge Function
...
declare
    ...
    -- FIXED: Using actual service role key (visible in Supabase dashboard > Project Settings > API)
    v_service_key text := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ5cndsa2J6eWxkemJzY3ZjcWpoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2OTE5OTM0OSwiZXhwIjoyMDg0Nzc1MzQ5fQ.oXscXwMFpyfVNdAgh-Y-OZFM6tJz5-3GlbpaFrzQno4';
begin
    ...
    loop
        ...
        -- Check if this time corresponds to any target_time
