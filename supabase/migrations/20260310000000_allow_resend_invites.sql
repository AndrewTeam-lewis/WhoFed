-- Allow resending invites by deleting existing pending invites before creating new ones
-- This prevents duplicate invites and allows users to resend emails
...
BEGIN
    ...
    -- DELETE any existing pending invites for this user/household combo (allows resending)
